...
{
    public class UpdateMotorcycleValidator : AbstractValidator<UpdateMotorcycleCommand>
    {
        private readonly IMotorcycleRepository _motorcycleRepository;

        public UpdateMotorcycleValidator(IMotorcycleRepository motorcycleRepository)
        {
